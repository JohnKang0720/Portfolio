          ...
          {POSTS.map((post, i) => (
            <Reveal key={post.id} delay={(i % 3) * 0.08}>
              <motion.button
                ...
                className="group flex h-full w-full flex-col rounded-2xl border border-ink-800 bg-ink-900/40 p-6 text-left transition-colors hover:border-ink-600 hover:bg-ink-850"
              >
